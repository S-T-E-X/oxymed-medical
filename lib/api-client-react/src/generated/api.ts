...
export const getListMarqueeItemsUrl = (params?: ListMarqueeItemsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/marquee?${stringifiedParams}` : `/api/marquee`
}

/**
 * @summary List marquee items
 */
export const listMarqueeItems = async (params?: ListMarqueeItemsParams, options?: RequestInit): Promise<MarqueeItem[]> => {

  return customFetch<MarqueeItem[]>(getListMarqueeItemsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListMarqueeItemsQueryKey = (params?: ListMarqueeItemsParams,) => {
    return [
    `/api/marquee`, ...(params ? [params] : [])
    ] as const;
    }


export const getListMarqueeItemsQueryOptions = <TData = Awaited<ReturnType<typeof listMarqueeItems>>, TError = ErrorType<unknown>>(params?: ListMarqueeItemsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listMarqueeItems>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListMarqueeItemsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listMarqueeItems>>> = ({ signal }) => listMarqueeItems(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listMarqueeItems>>, TError, TData> & { queryKey: QueryKey }
}

export type ListMarqueeItemsQueryResult = NonNullable<Awaited<ReturnType<typeof listMarqueeItems>>>
export type ListMarqueeItemsQueryError = ErrorType<unknown>
...
export function useListMarqueeItems<TData = Awaited<ReturnType<typeof listMarqueeItems>>, TError = ErrorType<unknown>>(
 params?: ListMarqueeItemsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listMarqueeItems>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListMarqueeItemsQueryOptions(params,options)
...
export const getCreateMarqueeItemUrl = () => {
 ...
 */
export const createMarqueeItem = async (marqueeItemInput: MarqueeItemInput, options?: RequestInit): Promise<MarqueeItem> => {

  return customFetch<MarqueeItem>(getCreateMarqueeItemUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateMarqueeItemMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createMarqueeItem>>, TError,{data: BodyType<MarqueeItemInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createMarqueeItem>>, TError,{data: BodyType<MarqueeItemInput>}, TContext> => {

const mutationKey = ['createMarqueeItem'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createMarqueeItem>>, {data: BodyType<MarqueeItemInput>}> = (props) => {
          const {data} = props ?? {};

          return  createMarqueeItem(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateMarqueeItemMutationResult = NonNullable<Awaited<ReturnType<typeof createMarqueeItem>>>
    export type CreateMarqueeItemMutationBody = BodyType<MarqueeItemInput>
    export type CreateMarqueeItemMutationError = ErrorType<unknown>

    /**
 * @summary Create marquee item
 */
export const useCreateMarqueeItem = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createMarqueeItem>>, TError,{data: BodyType<MarqueeItemInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createMarqueeItem>>,
        TError,
        {data: BodyType<MarqueeItemInput>},
        TContext
      > => {
      return useMutation(getCreateMarqueeItemMutationOptions(options));
    }

export const getGetMarqueeItemUrl = (id: number,) => {




  return `/api/marquee/${id}`
}

/**
 * @summary Get marquee item by id
 */
export const getMarqueeItem = async (id: number, options?: RequestInit): Promise<MarqueeItem> => {

  return customFetch<MarqueeItem>(getGetMarqueeItemUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetMarqueeItemQueryKey = (id: number,) => {
    return [
    `/api/marquee/${id}`
    ] as const;
    }
...
export const getGetMarqueeItemQueryOptions = <TData = Awaited<ReturnType<typeof getMarqueeItem>>, TError = ErrorType<ErrorResponse>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMarqueeItem>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetMarqueeItemQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getMarqueeItem>>> = ({ signal }) => getMarqueeItem(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMarqueeItem>>, TError, TData> & { queryKey: QueryKey }
}

export type GetMarqueeItemQueryResult = NonNullable<Awaited<ReturnType<typeof getMarqueeItem>>>
export type GetMarqueeItemQueryError = ErrorType<ErrorResponse>
...
export function useGetMarqueeItem<TData = Awaited<ReturnType<typeof getMarqueeItem>>, TError = ErrorType<ErrorResponse>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMarqueeItem>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetMarqueeItemQueryOptions(id,options)
...
export const getUpdateMarqueeItemUrl = (id: number,) => {
 ...
 */
export const updateMarqueeItem = async (id: number,
    marqueeItemUpdate: MarqueeItemUpdate, options?: RequestInit): Promise<MarqueeItem> => {

  return customFetch<MarqueeItem>(getUpdateMarqueeItemUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateMarqueeItemMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateMarqueeItem>>, TError,{id: number;data: BodyType<MarqueeItemUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateMarqueeItem>>, TError,{id: number;data: BodyType<MarqueeItemUpdate>}, TContext> => {

const mutationKey = ['updateMarqueeItem'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateMarqueeItem>>, {id: number;data: BodyType<MarqueeItemUpdate>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateMarqueeItem(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateMarqueeItemMutationResult = NonNullable<Awaited<ReturnType<typeof updateMarqueeItem>>>
    export type UpdateMarqueeItemMutationBody = BodyType<MarqueeItemUpdate>
    export type UpdateMarqueeItemMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Update marquee item
 */
export const useUpdateMarqueeItem = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateMarqueeItem>>, TError,{id: number;data: BodyType<MarqueeItemUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateMarqueeItem>>,
        TError,
        {id: number;data: BodyType<MarqueeItemUpdate>},
        TContext
      > => {
      return useMutation(getUpdateMarqueeItemMutationOptions(options));
    }

export const getDeleteMarqueeItemUrl = (id: number,) => {
 ...
 */
export const deleteMarqueeItem = async (id: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteMarqueeItemUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteMarqueeItemMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteMarqueeItem>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteMarqueeItem>>, TError,{id: number}, TContext> => {

const mutationKey = ['deleteMarqueeItem'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteMarqueeItem>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  deleteMarqueeItem(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteMarqueeItemMutationResult = NonNullable<Awaited<ReturnType<typeof deleteMarqueeItem>>>

    export type DeleteMarqueeItemMutationError = ErrorType<unknown>

    /**
 * @summary Delete marquee item
 */
export const useDeleteMarqueeItem = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteMarqueeItem>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteMarqueeItem>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getDeleteMarqueeItemMutationOptions(options));
    }
