            ...
            <>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  ["plcSystem", "PLC Sistemi"],
                  ["hmiModel", "HMI Modeli"],
                  ["productionDate", "Üretim Tarihi"],
                  ["installDate", "Devreye Alma", "date"],
                  ["customerFirm", "Müşteri Firma"],
                  ["customerDepartment", "Bölüm"],
                  ["customerLocation", "Lokasyon"],
                  ["customerContact", "Sorumlu Kişi"],
                  ["customerPhone", "İletişim / Tel"],
