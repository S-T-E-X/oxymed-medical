  ...
  await db
    ...
    .values([
      ...
      },
      {
        ...
        titleDe: "Pendantsystem",
        titleFr: "Système pendant",
        titleIt: "Sistema pensile",
        titleAr: "نظام بندانت",
        titleRu: "Потолочная консоль",
        titleFa: "سیستم پندانت",
        titleKa: "პენდანტის სისტემა",
        titleBg: "Пендaнтна система",
        titleAz: "Pendant sistemi",
      ...
      },
      {
        ...
        titleEn: "Medical Gas Alarm",
        titleDe: "Medizingas-Alarm",
        titleFr: "Alarme de gaz médicaux",
        titleIt: "Allarme per gas medicali",
        titleAr: "إنذار الغازات الطبية",
        titleRu: "Сигнализация медицинских газов",
        titleFa: "آلارم گازهای پزشکی",
        titleKa: "სამედიცინო გაზის სიგნალიზაცია",
        titleBg: "Аларма за медицински газове",
        titleAz: "Tibbi qaz siqnalizasiya paneli",
      ...
      },
      {
        ...
        titleEn: "Electrical & Data Unit",
        titleDe: "Elektro- und Dateneinheit",
        titleFr: "Unité électrique et data",
        titleIt: "Unità elettrica e dati",
        titleAr: "وحدة الكهرباء والبيانات",
        titleRu: "Электрический и информационный модуль",
        titleFa: "یونیت برق و دیتا",
        titleKa: "ელექტრო და მონაცემთა ბლოკი",
        titleBg: "Електрически и информационен модул",
        titleAz: "Elektrik və data bloku",
